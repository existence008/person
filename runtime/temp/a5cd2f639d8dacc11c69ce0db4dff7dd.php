<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\wamp\www\person\public/../application/index\view\Photoes\add.html";i:1489033070;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <link href="/static/main/css/plugins/dropzone/basic.css" rel="stylesheet">
    <link href="/static/main/css/plugins/dropzone/dropzone.css" rel="stylesheet">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="my-awesome-dropzone" class="dropzone" action="<?php echo url('index/Photoes/addDates'); ?>"
                          enctype="multipart/form-data">
                        <div class="dropzone-previews"></div>
                        <button type="submit" id="add" class="btn btn-primary pull-right">提交</button>
                    </form>
<!--                    <div>
                        <div class="m">
...
<script src="/static/main/js/plugins/dropzone/dropzone.js"></script>
<script>
    ...
    // 获取图片路径
    $("#add").click(function () {
        var len = $(".inserimg").length;
        var content = '';// 初始化一个变量来接受图片路径
        for (var i=0;i<len;i++){
            content += $(".inserimg").eq(i).attr("src")+"。\n";
        }
        $.ajax({
           type:'post',
            url:"<?php echo url('index/Photoes/addDates'); ?>",
            dataType:'json',
            data:{param:content},
